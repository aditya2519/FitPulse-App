...
import edu.csueb.codepath.fitness_tracker.fragments.ChartFragment;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.action_track:
                        ...
                        break;
                    case R.id.action_charts: // Add this case
                        fragment = new ChartFragment(); // Assuming you have created this fragment
                        break;
